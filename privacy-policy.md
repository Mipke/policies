...
This policy applies to all products built and maintained by Mipke LLC including Mipke Academy, The Investor, Praxly, and Local Tax Ledger.
...
* If we get an informal request from any person, organization, or entity, we do not assist. If you are an account owner who wants to export data from their accounts, you can request to do so by emailing jared@mipke.com
